...
\begin{document}
  ...
  \begin{frame}[fragile]
    ...
    \begin{figure}[!htb] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
      % \centering %图片居中
      \includegraphics[width=1\textwidth,height=0.8\textheight]{python-trial2.png} %插入图片，[]中设置图片大小，{}中是图片文件名
  ...
  \begin{frame}[fragile]
    ...
    \begin{figure}[!htb] %H为当前位置，!htb为忽略美学标准，htbp为浮动图形
      % \centering %图片居中
      \includegraphics[width=1\textwidth,height=0.8\textheight]{python-trial4.png} %插入图片，[]中设置图片大小，{}中是图片文件名
      % \caption{Main name 2} %最终文档中希望显示的图片标题
      % \label{Fig.main2} %用于文内引用的标签
    \end{figure}
  \end{frame}
